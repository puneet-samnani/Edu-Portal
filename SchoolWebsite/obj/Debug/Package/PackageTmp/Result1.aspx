...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolConnectionString %>" SelectCommand="SELECT [name] FROM [Student] WHERE ([std] = @std)">
        <SelectParameters>
