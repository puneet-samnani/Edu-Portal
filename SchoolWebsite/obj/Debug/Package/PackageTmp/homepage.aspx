<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homepage.aspx.cs" Inherits="SchoolWebsite.homepage" %>

<!DOCTYPE html>
<html>
<head>
<title>C.B.S.C College</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <font size="5"><a href="index.html">CHANDRA BALI SINGH INTER COLLEGE</a></font>
      <p>Fatehpur Pakdi , Shehjadpur Road ,Akbarpur , Ambedkar Nagar -224122</p>
    </div>
    <div class="fl_right">
  ...
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      ...
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/1.jpg" alt=""></a>
        <figcaption>
          <h2>HISTORY</h2>
          <p>The history of CHANDRA BALI SINGH INTER COLLEGE began when ground was broken for the basement of the school in July 1982.The building became......</p>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/2.jpg" alt=""></a>
        <figcaption>
          ...
          <p>Our academic staff are all research active scholars who bring their specialist knowledge and passion into the teaching context ensuring...... </p>
...
Supporting and enhancing the 'student experience' throughout the student lifecycle (from first contact through to becoming alumni) is critical to the success.... </p>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/4.jpg" alt=""></a>
        <figcaption>
          <h2>ALUMUNI</h2>
          <p>Alumni are deeply committed to the program and its students. They serve as instructors, mentors, preceptors, guest lecturers, and are...</p>
    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_quarter first"> 
          <!-- ################################################################################################ -->
          <ul class="nospace">
            <li class="btmspace-15"><a href="#"><em class="heading">Prospective Students</em> <img class="borderedbox" src="images/demo/prospective.jpg" alt=""></a></li>
            <li class="btmspace-15"><a href="#"><em class="heading">Current Students</em> <img class="borderedbox" src="images/demo/220x95.jpg" alt=""></a></li>
            <li><a href="#"><em class="heading">Alumni</em> <img class="borderedbox" src="images/demo/alumuni.jpg" alt=""></a></li>
          </ul>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Left Column --> 
        ...
        <div class="one_quarter sidebar"> 
          ...
          <div class="sdb_holder">
            <h6>Virtual Tour</h6>
            <div class="mediacontainer"><img src="images/demo/video.gif" alt="jaf">
