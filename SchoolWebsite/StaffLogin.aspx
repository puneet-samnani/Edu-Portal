...
<head>
     <title>Rajasthan Edu-Portals</title>
		...
		<!--//webfonts-->
           ...
           <audio id="audio1" src="bird.wav" controls preload="auto" hidden="hidden" autobuffer>
          </audio>
...
<body onload="javascript:EvalSound('audio1')" >
	<div class="main">
		<form id="form1" runat="server">
    		<h1><span>RAJASTHAN Edu-Portal Login</span></h1>
  			<div class="inset">
	  			<p>
            ...
            <p class="p-container">
			      ...
			      <asp:Label ID="Label3" runat="server" ForeColor="Yellow" Text="By RiskyDreamers"></asp:Label>
            </p>
		</form>
	</div>  
