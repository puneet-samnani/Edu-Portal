<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty.aspx.cs" Inherits="SchoolWebsite.Faculty" %>
							...
							<div class="body">
									...
									<div id="sidebar">
										...
										<ul class="navigation">
                                            ...
                                            <li><a href="Result1.aspx">INSERT MARKS</a></li>
									...
									<div id="content" >
									    ...
									    <img src="rajcartoons/cartoon-map.png" width="726" height="546" alt="" title="">
										<div class="featured">
										      <div class="header">
											     <ul>
														<li class="first">
