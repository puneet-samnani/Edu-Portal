<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result1.aspx.cs" Inherits="SchoolWebsite.InputResult" %>
<!DOCTYPE html >
...
<body>
	  ...
	  <div id="background">
            ...
            <asp:ListItem>12(Bio)</asp:ListItem>
                                                        ...
                                                        <p>
                                                            &nbsp;</p>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource1" ForeColor="Black" Visible="False">
        <Columns>
        ...
        <SortedDescendingHeaderStyle BackColor="#383838" />
													    ...
													    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolConnectionString4 %>" SelectCommand="SELECT [name] FROM [Student] WHERE ([std] = @std)">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="std" SessionField="class1" Type="String" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    ...
                                                    <li>
													    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Insert marks" Visible="False" />
